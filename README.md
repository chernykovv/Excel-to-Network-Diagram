...
```bash
$ git clone https://github.com/chernykovv/Excel-to-Network-Diagram.git
...
In [examples](https://github.com/chernykovv/Excel-to-Network-Diagram/tree/main/examples) directory you will 
